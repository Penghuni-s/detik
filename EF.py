...
print(" [anak anjing]
\x1b[1;96m--------------------------------------------------------
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author   : xnxx
...
def menu():
	...
	print(" SC MASIH DALAM PERKEMBANGN")
	print(" "+p+"---------------------------------------------")
	print
	print(" 1\033[1;94m[INI SCRIP HASIL RECODE!!!!]
    print
	print(""+p+" 1\033[1;92m1. Crack Dari Friend/Public")
	print(" 1\033[1;93m2. Crack Dari Follower")
	print(" 1\033[1;94m3. Crack Dari Postingan")
	print(" 1\033[1;95m4. Cek Hasil Crack")
	print(" 1\033[1;96m5. Setting User Agent")
	print(" 1\033[1;97m6. Cek Info Account Facebook")
	print(" 1\033[1;98m0. Logout")
	print
	ask = raw_input(" | Pilih : ")
	if ask =="":
		menu()
		...
		if ask =="":
			...
			try:
				...
				exit(" \033[0;97m[\033[0;91m!\033[0;97m] yahaha gak dapat")
		elif ask == "2" or ask == "02":
			try:
